...
@WebServlet(name = "registerScreen", urlPatterns = {"/registerScreen"})
public class registerScreen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet registerScreen</title>");   
            ...
            out.println("<input type='hidden' name='command' value='registerCommand'>");
            out.println("<p>Clave: </p> <p><input type='password' name='pass'></p>");
            out.println("<p><input type='submit' value='Registrarse'></p></div></form>");  
            out.println("</body>");
            out.println("</html>");
        }
    }
